export const HomeIcon = ({ classname, width = '18px', height = '18px' }) => (
   <svg
      className={classname}
      stroke="currentColor"
      fill="none"
...
export const StonkeIcon = ({ classname, width = '18px', height = '18px' }) => (
   <svg
      className={classname}
      stroke="currentColor"
      fill="none"
...
export const GenreIcon = ({ classname, width = '18px', height = '18px' }) => (
   <svg
      className={classname}
      stroke="currentColor"
      fill="none"
...
export const GlassIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      stroke="currentColor"
      fill="none"
      strokeWidth="2"
...
export const XmaskIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      className={classname}
      width={width}
      height={height}
...
export const FacebookIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      className={classname}
      width={width}
      height={height}
...
export const GoogleIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      className={classname}
      width={width}
      height={height}
...
export const UserIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      className={classname}
      width={width}
      height={height}
...
export const BackIcon = ({ classname, width = '20px', height = '20px' }) => (
   <svg
      className={classname}
      width={width}
      height={height}
...
export const StarIcon = ({ classname, width, height }) => (
   <svg
      stroke="currentColor"
      fill="white"
      strokeWidth="2"
...
export const FilmIcon = ({ classname, widht, height }) => (
   <svg
      stroke="currentColor"
      fill="none"
      strokeWidth="2"
